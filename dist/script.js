...
var test = function test() {
  var featuresItems = document.querySelector('.features__items');
  ...
  function createItem(src, title, desc) {
    ...
    var itemContent = "\n    <img class=\"features__item-img\" src=\"".concat(src, "\" alt=\"feature\">\n    <h3 class=\"features__item-title\">").concat(title, "</h3>\n    <div class=\"features__item-text\">").concat(desc, "</div>\n  ");
  ...
  request.onreadystatechange = function () {
    if (request.readyState == 4 && request.status == 200) {
      var featuresArr = JSON.parse(request.responseText);
